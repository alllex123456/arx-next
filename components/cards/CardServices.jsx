...
const CardServices = ({ title, text, button, image }) => {
  return (
    <div className="bg-[--gray-10] rounded-[--border-radius] overflow-hidden grid grid-cols-[1fr_2fr] gap-[--flex-gap-small] max-w-[--width] ||| xl:grid-cols-2 lg:grid-cols-1">
      <div className="py-[--padding] pl-[4.8rem] flex flex-col gap-[--flex-gap-large] ||| lg:pl-[--padding] lg:px-[--padding]">
        ...
        <Button type="blue" label={button.label} onClick={button.onClick} />
      </div>
